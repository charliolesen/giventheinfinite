...
async function loadChapter(chapter, container, chapters) {
  ...
  try {
    ...
    giscusScript.setAttribute('data-repo-id', 'R_kgDORnVoMg');
    giscusScript.setAttribute('data-category', 'General');
    giscusScript.setAttribute('data-category-id', 'DIC_kwDORnVoMs4C5iQ0');
    ...
    giscusScript.setAttribute('data-theme', 'dark_tritanopia');
